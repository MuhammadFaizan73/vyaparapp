...
export function PartiesIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      ...
      <path d="M15.5 15.8c2.8 0 5 1.3 6 3.8" strokeLinecap="round" />
    </svg>
  );
}
...
export function PurchaseIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      <path d="M3 4h2l2.4 11.2a2 2 0 0 0 2 1.6h7.2a2 2 0 0 0 2-1.5L20.5 8H6.2" strokeLinejoin="round" strokeLinecap="round" />
...
export function PlansIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      ...
      <path d="m9 13-2 8 5-3 5 3-2-8" strokeLinejoin="round" strokeLinecap="round" />
    </svg>
  );
}
...
export function PlusAction() {
  return (
    <svg className="nav-item__action" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export function ArrowRight() {
  return (
    <svg className="premium-btn__arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
